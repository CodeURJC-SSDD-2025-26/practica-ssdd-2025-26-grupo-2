    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
            .authorizeHttpRequests(authorize -> authorize
                // Public pages
                .requestMatchers("/", "/index", "/signin", "/about", "/contact", "/viajes", "/contact.html", "/forgot-password").permitAll()
                ...
                .requestMatchers("/admin.html", "/admin/**", "/graphJourney.html", "/graphUser.html", "/journeyManagement.html", 
                         "/userManagement.html", "/addJourney.html", "/editJourney.html" , "/userReservas.hmtl", "/userReservas",
                        "/admin_user_reviews.html", "/editReservationPage.html").hasRole("ADMIN") 
